                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="card card-primary">
                                    ...
                                    <div class="car-list-info without-bar">
                                        <h2><a href="<?= base_url('customer/dashboard/detail_mobil/') . $mb->id_mobil ?>"><?= $mb->merk ?></a>
                                        </h2>
                                        ...
                                        <?php if ($mb->status_mobil == 1) { ?>
                                            <a href="<?= base_url('customer/rental/tambah_rental/') . $mb->id_mobil ?>" class="btn btn-primary"><i class="fa fa-car text-success"></i> Sewa</a>
                                            <a href="<?= base_url('customer/dashboard/detail_mobil/') . $mb->id_mobil ?>" class="btn btn-primary"><i class="fa fa-search-plus"></i> Detail</a>
                                        <?php } else { ?>
                                            <a href="javascript:;" class="btn disabled btn-primary"><i class="fa fa-times-circle text-danger"></i> Disewa</a>
                                            <a href="<?= base_url('customer/dashboard/detail_mobil/') . $mb->id_mobil ?>" class="btn btn-primary"><i class="fa fa-search-plus"></i> Detail</a>
                                        <?php } ?>
                                    </div>
                                </div>
